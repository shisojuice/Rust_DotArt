...
*/
export function dot_art_generate(input_size, image_data) {
    const ptr0 = passStringToWasm0(input_size, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(image_data, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    wasm.dot_art_generate(ptr0, len0, ptr1, len1);
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('rust_dotart_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
